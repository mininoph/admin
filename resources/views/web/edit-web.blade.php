                ...
                <div class="card ">
                    ...
                    <div class="card-body">
                        ...
                        <input type="hidden" name="id" value="{{$web->id}}"/>
                            ...
                            <div class="form-group row">
                                <label for="exampleInputPassword2" class="col-sm-3 col-form-label">{{ __('Open Article In')}}</label>
                                <div class="col-sm-9">
                                  <select name="browser_type" class="form-control" required>
                                      <option value="0" {{($web->browser_type == '0') ? 'selected' : ''}}> IN App</option>
                                      <option value="1" {{($web->browser_type == '1') ? 'selected' : ''}}> Chrome Custom Tab</option>
                                  </select>
                                </div>
                            </div>
